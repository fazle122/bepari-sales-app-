...
//            useRootNavigator: false,
              ...
              context: context,
               builder: (context) => ConfirmInvoiceDialog(formData,null,null)
             );
...
//            useRootNavigator: false,
            barrierDismissible: false,
            context: context,
            builder: (context) => ConfirmInvoiceDialog(formData,invoiceStatus,null)
        );

        // response = await Provider.of<Orders>(context, listen: false).createInvoiceWithPayment(formData);
                  ...
                  Container(
                    ...
                    child: RaisedButton(
                      ...
                      onPressed: () async{
                        ...
                        if(cart.items.length < 0){
                          _scaffoldKey.currentState.showSnackBar(_snackBar('Please add item to cart'));
                        }else if(_amountController.text == null || _amountController.text == ''){
                          _scaffoldKey.currentState.showSnackBar(_snackBar('Please insert amount'));
                        }else if(cart.items.length > 0 && _amountController.text != null){
