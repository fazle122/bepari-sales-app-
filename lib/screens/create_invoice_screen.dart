...
//   }
//
//   Widget _dialogWidget(String title,String confirmMessage,String btn1Txt,String btn2Txt,btn3Txt,FormData formData,Cart cart,double invoiceAmount,int status){
//     return AlertDialog(
//       title: Center(child:Text(title)),
//       content:
//       Container(
...
//             context: context,
//             builder: (context) =>
//                 _dialogWidget('Save invoice', 'Are your sure, you want to save invoice only?', 'Save', 'Cancel', null, formData,cart,invoiceAmount,0)
//           // AlertDialog(
