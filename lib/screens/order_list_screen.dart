...
//      }
  ...
  List<OrderItem> getOrderData1(Map<String,dynamic> filters,int pageCount) {
    if (_isInit) {
      if (!isPerformingRequest) {
        setState(() {
          isPerformingRequest = true;
...
//
//import 'package:beparydelivary/providers/orders.dart';
//import 'package:beparydelivary/screens/order_detail_screen.dart';
//import 'package:beparydelivary/screens/signature_screen.dart';
//import 'package:beparydelivary/widgets/app_drawer.dart';
//import 'package:beparydelivary/widgets/order_fiter_dialog.dart';
//import 'package:flutter/material.dart';
//import 'package:provider/provider.dart';
//import 'package:intl/intl.dart';
...
//        _isLoading = true;
//      });
//      Provider.of<Orders>(context).fetchAndSetOrders(filters,1).then((_) {
//        if (!mounted) return;
//        setState(() {
//          _isLoading = false;
//        });
...
//              )
//            : Consumer<Orders>(
//                builder: (context, orderData, child) => orderData
//                            .orders.length >
//                        0
//                    ? ListView.builder(
...
//                                                            child: Text('Confirm'),
//                                                            onPressed: () async{
//                                                              await Provider.of<Orders>(context, listen: false).cancelOrder(orderData.orders[i].id.toString(), commentController.text);
//                                                              if (!mounted) return;
//                                                              setState(() {
//                                                                _isInit = true;
//                                                              });
